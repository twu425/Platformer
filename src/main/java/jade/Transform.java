...
/** This component is used to store the coordinates, scale and rotation.(as well as name)
 *  It also exposes the variables to ImGui **/
...
public class Transform extends Component {
    ...
    /** Determines if an object with a transformation has the same transformation */
    @Override
