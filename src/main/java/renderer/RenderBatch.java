...
public class RenderBatch implements Comparable<RenderBatch> {
    ...
    public boolean destroyIfExists(GameObject go) {
        ...
        for (int i=0; i < numSprites; i++) {
            // Loop through all of the sprites. If the sprite matches the one given from the gameobject,
            // Remove it by deleting it and shifting all other sprites in the array on the right to the left
            if (sprites[i] == sprite) {
        ...
        // If we couldn't find the sprite return false
        return false;
    }
